...
export class DataService {
  ...
  contacts = [
    ...
    {id: 5, name: "Contact 001", description: "Contact 001 des", email: "c001@email.com"},
    {id: 6, name: "Contact 002", description: "Contact 002 des", email: "c002@email.com"},
    {id: 7, name: "Contact 003", description: "Contact 003 des", email: "c003@email.com"},
    {id: 8, name: "Contact 004", description: "Contact 004 des", email: "c004@email.com"}
  ];
